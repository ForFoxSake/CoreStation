		...
		if (0) // Character Settings#
			...
			if(config.mutant_races)
				...
				if(kpcode_cantaur(pref_species.id))
					dat += "<b>Taur:</b><a href='?_src_=prefs;preference=be_taur;task=input'>[be_taur ? "Yes" : "No"]</a><BR>"
			else
			...
			if(config.mutant_humans)
				...
				if("tail_human" in pref_species.mutant_bodyparts)
					...
					dat += "<a href='?_src_=prefs;preference=mutant_tail;task=input'>[mutant_tail]</a><BR>"
			...
			dat += "</tr><tr><td width='24%' valign='top'>"
			dat += "<h3>Wings</h3>"
			dat += "<a href='?_src_=prefs;preference=mutant_wing;task=input'>[mutant_wing]</a><BR>"
			dat += "<span style='border: 1px solid #161616; background-color: #[wingcolor];'>&nbsp;&nbsp;&nbsp;</span> <a href='?_src_=prefs;preference=wingcolor;task=input'>Change</a></td>"

			if(pref_species.snowflake)
				dat += "<td valign='top' width='21%'>"
				dat += "<h3>Primary Color</h3>"
				if(special_color[1])
					dat += "<span style='border:1px solid #161616; background-color: #[special_color[1]];'>&nbsp;&nbsp;&nbsp;</span> <a href='?_src_=prefs;preference=special_color;which=1;task=input'>Set</a><BR>"
				else
					dat += "<a href='?_src_=prefs;preference=special_color;which=1;task=input'>Not Set</a><BR>"
				dat += "</td>"
			...
			if (!((MUTCOLORS in pref_species.specflags) || (MUTCOLORS_PARTSONLY in pref_species.specflags)))
				...
				if(special_color[2])
					dat += "<span style='border:1px solid #161616; background-color: #[special_color[2]];'>&nbsp;&nbsp;&nbsp;</span> <a href='?_src_=prefs;preference=special_color;which=2;task=input'>Set</a><BR>"
				else
					dat += "<a href='?_src_=prefs;preference=special_color;which=2;task=input'>Not Set</a><BR>"
				dat += "</td>"
			...
			if(pref_species.snowflake)
				...
				if(special_color[3])
					dat += "<span style='border:1px solid #161616; background-color: #[special_color[3]];'>&nbsp;&nbsp;&nbsp;</span> <a href='?_src_=prefs;preference=special_color;which=3;task=input'>Set</a><BR>"
				else
					dat += "<a href='?_src_=prefs;preference=special_color;which=3;task=input'>Not Set</a><BR>"
				dat += "</td>"
